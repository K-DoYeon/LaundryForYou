	...
	<div class="container-login">
		...
		<form method="post" name="loginform">
			...
			<div class="submitBtnBox-login">
				<input type="submit" formaction ="loginProc.jsp" class="submitBtn-login ptbt-login" value="로그인" />
			</div>
			
			<div class="submitBtnBox-login">
				<input type="submit" formaction ="testLoginProc.jsp" class="submitBtn-login" value="테스터용 로그인" />
			</div>
