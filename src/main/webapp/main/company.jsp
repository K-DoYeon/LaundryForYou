...
<link rel="stylesheet" href="../css/company.css">
	...
	<div class="com-banner"></div>
	<p class="com-intro">회사소개</p>
	<div class="about-us">
		<div class="about-left">
			<span>about us</span>
			<div class="about-left-box">
				<p>xxtx</p>
				<p class="left-box">같은 곳을 바라보고 서로가 서로를 발전시키기 위해<br> 
				앞으로 나아가는 회사입니다.</p>
			</div>		
		</div>
	...
	<div class="vision">
		...
		<div class="vision-three">
			<p>Trouble Shooting</p>
			<p>문제해결</p>
		</div>
		<div class="vision-four">
			<p>Self-Development</p>
			<p>자기개발</p>
		</div>
	</div>
	
	<div class="orgChart-com">
		<p>organization chart</p>
		<div class="orgChartImg-com">
			<img alt="orgChart" src="../img/orgChart.png">
		</div>
	</div>
	
	<div class="intro-com">
	
		<div class="introBox-com">
		...
		<div class="introBox-com">
			...
			<div class="introEmployee-com">
				...
				<div class="portfolio-com">
					...
					<a href="mailto://alicehong1819@naver.com">
						<i class="ri-mail-send-fill"></i>
					</a>
				</div>
			</div>
